      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Keep Coding.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Keep Coding, accessible from{" "}
            <a
              href="https://we-coding.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://we-coding.vercel.app/
            </a>
          </p>
        </li>
        <li>
