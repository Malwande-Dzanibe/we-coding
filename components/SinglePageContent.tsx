...
function SinglePageContent({ post }: Props) {
  ...
  return (
    <div>
      <PortableText className="portable" content={post.intro} />
      {codingChallenge && (
        <div className="highl">
          <SyntaxHighlighter
            language="javascript"
      ...
      {post.afterFirstChallenge && (
        <PortableText className="portable" content={post.afterFirstChallenge} />
      )}
      {codingChallenge2 && (
        <div className="highl">
          <SyntaxHighlighter
      ...
      <PortableText className="portable" content={post.outro} />
    </div>
  );
}
